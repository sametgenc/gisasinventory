...
import { LogOut, UserPlus, LogIn, LayoutDashboard, Settings, User, Shield, Key, Smartphone, Package, Layers, Building2, Menu, X, ChevronDown, Ship, Users } from 'lucide-react';
